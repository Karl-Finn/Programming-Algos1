...
NTS: This algorithm uses just lists and conditional statements to solve the problem and
     provide the correct results. It is a bit more complicated than the algorithm that
     uses dictionaries and shows the benefit of using dictionaries.
